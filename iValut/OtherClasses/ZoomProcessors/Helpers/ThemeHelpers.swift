...
class ThemeHelpers {
    ...
    class func getCustomizationForTheme(theme: String) -> FaceTecCustomization {
        ...
        if theme == "FaceTec Theme" {
            ...
            let buttonBackgroundDisabledColor = UIColor(red: 173/255.0, green: 173/255.0, blue: 173/255.0, alpha: 1)
            ...
            currentCustomization.idScanCustomization.activeTorchButtonImage = UIImage(named: "active_torch_black")
            currentCustomization.idScanCustomization.inactiveTorchButtonImage = UIImage(named: "inactive_torch_black")
            ...
            let backgroundLayer = CAGradientLayer.init()
            let buttonTextDisabledColor = UIColor(red: 215/255.0, green: 215/255.0, blue: 215/255.0, alpha: 1)
            let buttonBackgroundDisabledColor = UIColor(red: 148/255.0, green: 184/255.0, blue: 180/255.0, alpha: 1)
            ...
            let buttonTextDisabledColor = UIColor(red: 117/255.0, green: 117/255.0, blue: 117/255.0, alpha: 1)
            let buttonBackgroundDisabledColor = UIColor(red: 191/255.0, green: 174/255.0, blue: 156/255.0, alpha: 1)
            ...
            let buttonTextDisabledColor = UIColor(red: 237/255.0, green: 28/255.0, blue: 36/255.0, alpha: 0.3)
            ...
            let buttonTextDisabledColor = UIColor(red: 29/255.0, green: 23/255.0, blue: 79/255.0, alpha: 0.3)
    ...
    class func getDynamicDimmingCustomizationForTheme(theme: String) -> FaceTecCustomization? {
        ...
        if theme == "FaceTec Theme" {
            currentDynamicDimmingCustomization = nil
        }
        else if theme == "Config Wizard Theme" {
            currentDynamicDimmingCustomization = nil
        }
            ...
            // Overlay Customization
            currentDynamicDimmingCustomization?.overlayCustomization.brandingImage = UIImage(named: "ekyc_logo")
            // Guidance Customization
            ...
            currentDynamicDimmingCustomization?.guidanceCustomization.readyScreenOvalFillColor = primaryColor.withAlphaComponent(0.2)
            currentDynamicDimmingCustomization?.guidanceCustomization.readyScreenTextBackgroundColor = backgroundColor
            currentDynamicDimmingCustomization?.guidanceCustomization.retryScreenImageBorderColor = primaryColor
